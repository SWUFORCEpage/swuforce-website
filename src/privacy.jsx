    ...
    <div className="container privacy-layout">
      ...
      <Row title="1. 처리 목적 및 개인정보 항목">
        <table><thead><tr><th>업무</th><th>처리 목적과 항목</th></tr></thead><tbody>
          ...
          <tr><td>학회 소식·활동 사진</td><td>운영진이 공개용으로 선정한 행사 기록, 사진, 소개 글 및 외부 원문 링크를 게시합니다. 사진에 개인이 식별될 수 있는 정보가 포함되는 경우 게시 전 공개 권한과 정보주체의 동의 여부를 확인합니다. 원본 파일의 위치 메타데이터 등도 확인합니다.</td></tr>
      ...
      <Row title="2. 처리 및 보유 기간">
        <ul><li>회원 계정과 승인 정보: 회원 탈퇴 또는 이용 목적 종료까지. 법정 보존 의무가 있는 경우 해당 정보만 별도 분리 보관합니다.</li>
          ...
          <li>학회 공지·활동 기록 및 사진: 운영진이 게시물을 삭제하거나 공개 목적이 종료될 때 정리합니다. 공지 삭제 시 연결된 공개 사진 원본의 별도 삭제 여부도 점검합니다. 백업·CDN 캐시의 잔존 기간은 서비스 제공자의 정책에 따릅니다.</li>
      ...
      <Row title="4. 외부 서비스 이용 및 개인정보 처리 현황">
        ...
        <table><thead><tr><th>외부 서비스</th><th>서비스 이용 목적 및 처리 역할</th></tr></thead><tbody>
          <tr><td>Supabase</td><td>회원 인증·이메일 확인, 학회원 정보, 게시판·멘토링 데이터 및 공개용 학회 사진 파일 저장. 프로젝트의 주 데이터 저장 지역은 선택한 리전에 따릅니다. 운영 로그·지원 업무 등 일부 처리는 다른 지역에서 이루어질 수 있으므로 적용 계약과 계정 설정을 별도로 확인합니다.</td></tr>
